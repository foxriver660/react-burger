...
const RegisterPage: FC = React.memo(() => {
  ...
  return (
    <FormOverlay type="form">
      <Form onSubmit={(e) => handleSubmit(e, registerUser, PATH.HOME)} formName="Регистрация" mainForm={true}>
        <InputName value={form.name} onChange={handleChange} placeholder="Имя" />
      ...
      <p className={`${classes.clarification} text text_type_main-default text_color_inactive`}>
        ...
        <Link className={classes.link} to="/react-burger/login">
          Войти
        </Link>
      </p>
    </FormOverlay>
